...
SCORM_1_3.ActivityTreeNode.prototype = {
    ...
    addNode: function (title, identifier, url, scormType, isvisible) {
        var $0 = new SCORM_1_3.ActivityTreeNode();
        $0.$3 = this;
        $0.$4 = title;
        $0.$5 = identifier;
        $0.$6 = url;
        ...
        $0.$8 = isvisible;
        $0.$0 = this.$0 + 1;
        $0.$13 = new SCORM_1_3.ActivityTreeNodeSequencing($0);
        this.$2.add($0);
        return $0;
    },
    ...
    hasSuspendedChildren: function () {
        var $enum1 = this.$2.getEnumerator();
        while ($enum1.moveNext()) {
            var $0 = $enum1.get_current();
            if ($0.get_isSuspended()) {
                return true;
            }
        }
        return false;
    ...
    getChildrenIndex: function () {
        ...
        var $0 = 0;
        var $enum1 = this.getParent().getChildrens().getEnumerator();
        while ($enum1.moveNext()) {
    ...
    getLastChildren: function () {
        ...
        if (this.getChildrensCount() > 0) {
            $0 = this.getChildrens()[this.getChildrensCount() - 1];
        }
        return $0;
    },
    ...
    getNextSibling: function () {
        var $0 = null;
        var $1 = this.getChildrenIndex();
        if ($1 < this.getParent().getChildrensCount() - 1) {
            $0 = this.getParent().getChildrens()[$1 + 1];
        }
        return $0;
    },
    ...
    getPath: function (toNode, inclusiveThis, inclusiveTo, reverse) {
        ...
        while ($1.getParent() != null) {
            if (!inclusiveTo && $1 === toNode) {
                break;
            }
            $0.add($1);
            if (toNode === $1) {
    ...
    getList: function (toNode, inclusiveThis, inclusiveTo) {
        ...
        var $1 = this.getChildrenIndex();
        var $2 = toNode.getChildrenIndex();
        var $3 = this.getParent().getChildrens();
        if ($2 > $1) {
            for (var $4 = $1; $4 <= $2; $4++) {
                if (!inclusiveThis && $4 === $1) {
                    continue;
                }
                if (!inclusiveTo && $4 === $2) {
                    continue;
    ...
    updateSequencingState: function () {
        ...
        var $0 = 'cmi.completion_status';
        var $1 = 'cmi.progress_measure';
        var $2 = 'cmi.success_status';
        var $3 = 'cmi.score.scaled';
        var $4 = 'cmi.score.raw';
        var $5 = 'cmi.score.min';
        var $6 = 'cmi.score.max';
        var $7 = 0;
        if (this.$13.getObjectivesCount() > 0 && this.$13.getPrimaryObjective() === this.$13.getObjectiveByIndex(0)) {
            if (!this.$16($0)) {
                $0 = 'cmi.objectives.0.completion_status';
            }
            if (!this.$16($2)) {
                $2 = 'cmi.objectives.0.success_status';
            }
            if (!this.$16($1)) {
                $1 = 'cmi.objectives.0.progress_measure';
            }
            if (!this.$16($3)) {
                $3 = 'cmi.objectives.0.score.scaled';
            }
            if (!this.$16($4)) {
                $4 = 'cmi.objectives.0.score.raw';
            }
            if (!this.$16($5)) {
                $5 = 'cmi.objectives.0.score.min';
            }
            if (!this.$16($6)) {
                $6 = 'cmi.objectives.0.score.max';
            }
            $7 = 1;
        }
        var $8 = this.$13.status;
        var $9 = null;
        var $A = true;
        while ($A) {
            if ((this.$13.completionSetByContent || this.$16($0))) {
                $8.set_attemptCompletionStatus(this.getDataTreeValue($0) === 'completed');
                $8.set_attemptProgressStatus(this.getDataTreeValue($0) !== 'unknown');
                if (this.$13.status === $8) {
                    this.$13.completionSetByContent = true;
                }
            }
            if ((this.$13.objectiveSetByContent || this.$16($2))) {
                $8.set_objectiveSatisfiedStatus(this.getDataTreeValue($2) === 'passed');
                $8.set_objectiveProgressStatus(this.getDataTreeValue($2) !== 'unknown');
                if (this.$13.status === $8) {
                    this.$13.objectiveSetByContent = true;
                }
            }
            if (this.$16($1)) {
                $8.attemptCompletionAmountStatus = true;
                $8.set_attemptCompletionAmount(parseFloat(this.getDataTreeValue($1)));
            }
            if (this.$16($3)) {
                $8.set_objectiveMeasureStatus(true);
                $8.set_objectiveNormalizedMeasure(parseFloat(this.getDataTreeValue($3)));
            } else if (!$8.objectiveMeasureStatusFromGlobal) {
                $8.set_objectiveMeasureStatus(false);
                $8.set_objectiveNormalizedMeasure(0);
            }
            $8.set_scoreRaw(this.getDataTreeValue($4));
            $8.set_scoreMin(this.getDataTreeValue($5));
            $8.set_scoreMax(this.getDataTreeValue($6));
            if ($9 != null && !$9.contributeToRollup) {
                if ($9.satisfiedByMeasure) {
                    if ($8.get_objectiveNormalizedMeasure() >= $9.minNormalizedMeasure) {
                        $8.set_objectiveProgressStatus(true);
                        $8.set_objectiveSatisfiedStatus(true);
                    } else {
                        $8.set_objectiveProgressStatus(true);
                        $8.set_objectiveSatisfiedStatus(false);
                    }
                }
            }
            if (this.$13.getObjectivesCount() >= $7 + 1) {
                $0 = 'cmi.objectives.' + $7 + '.completion_status';
                $2 = 'cmi.objectives.' + $7 + '.success_status';
                $1 = 'cmi.objectives.' + $7 + '.progress_measure';
                $3 = 'cmi.objectives.' + $7 + '.score.scaled';
                $4 = 'cmi.objectives.' + $7 + '.score.raw';
                $5 = 'cmi.objectives.' + $7 + '.score.min';
                $6 = 'cmi.objectives.' + $7 + '.score.max';
                $9 = this.$13.getObjectiveByIndex($7);
                $8 = $9.status;
                $7++;
            } else {
                $A = false;
    ...
    setDataTreeValue: function (dataElement, value, isSetBySCO) {
       var $0 = this.$F[dataElement];
       //jsonSay({ "called": "API.js setDataTreeValue ", "dataElement": dataElement, "value": value });
         if (!isUndefined($0)) {
            $0['value'] = value;
            if (isSetBySCO) {
                $0['setbysco'] = true;
    ...
    getDataTreeValue: function (dataElement) {       
        ...
        //jsonSay({ "called": "API.js getDataTreeValue", "dataElement": dataElement, "returned": $0['value'] });
        return $0['value'];
    },
    $16: function ($p0) {
        if ($p0 === 'cmi.completion_status' || $p0 === 'cmi.success_status') {
            if (this.getDataTreeValue('cmi.mode') === 'normal' && this.getDataTreeValue('cmi.credit') === 'credit') {
                if ($p0 === 'cmi.completion_status' && this.getDataTreeValue('cmi.completion_threshold') != null) {
                    return false;
                } else if ($p0 === 'cmi.success_status' && this.getDataTreeValue('cmi.scaled_passing_score') != null) {
                    return false;
                }
            }
        }
...
SCORM_1_3.ActivityTree = function (selectedOrganizationIdentifier, resumeAllIdentifier, storedStatuses, globalObjectives) {
    ...
    this.$17 = selectedOrganizationIdentifier;
    ...
    if (!isNullOrUndefined(globalObjectives) && Object.getKeyCount(globalObjectives) > 0) {
        this.$25 = true;
        var $dict1 = globalObjectives;
        for (var $key2 in $dict1) {
            var $0 = {
                key: $key2,
                value: $dict1[$key2]
            };
            if (!isNullOrUndefined(($0.value).objectives)) {
                ($0.value).objectives.clear();
            }
        }
        this.$20 = globalObjectives;
    }
}
SCORM_1_3.ActivityTree.prototype = {
    ...
    evaluateDeliveryRequest: function (validationNavigationRequest) {
        this.$24 = true;
        var $0 = this.get_$2B();
        API_BASE.LOG.silent = true;
        try {
            var $1 = validationNavigationRequest;
    ...
    isValidNavigationRequest: function (validationNavigationRequest, isExpectTheSameChoice) {
        ...
        if (validationNavigationRequest.startsWith('jump.') || validationNavigationRequest.startsWith('choice.')) {
            $0 = isExpectTheSameChoice;
        }
        var $1 = this.evaluateDeliveryRequest(validationNavigationRequest);
        return $1 != null && (($0) ? $1.getIdentifier() === this.get_$39() : true);
    },
    requestNavigation: function (navigationRequest) {
        if (!this.$24 && this.getActiveAPI() != null && this.getActiveAPI().isInitAttempted() && !this.getActiveAPI().isFinishAttempted()) {
            ...
            this.onEventSCO(new API_BASE.BaseActivityTreeNodeEventArgs(null, 3));
        } else {
            API_BASE.LOG.displayMessage('Process Navigation: ' + navigationRequest, '0', null);
            this.set_$45(null);
            this.set_$2D(null);
            this.set_$3B(null);
            this.set_$35(null);
            ...
            if (navigationRequest === 'start') {
                ...
                var $0 = navigationRequest.match(new RegExp('^{target=(' + API_BASE.BaseUtils.ncName + ')}jump$'));
                if ($0 != null && $0.length >= 2 && !isNullOrUndefined($0[1]) && $0[1].length > 0) {
                    this.set_$29(14);
                    this.set_$39($0[1]);
                }
            } else if (navigationRequest.endsWith('}choice')) {
                var $1 = navigationRequest.match(new RegExp('^{target=(' + API_BASE.BaseUtils.ncName + ')}choice$'));
                if ($1 != null && $1.length >= 2 && !isNullOrUndefined($1[1]) && $1[1].length > 0) {
                    this.set_$29(8);
                    this.set_$39($1[1]);
                }
    ...
    $46: function ($p0) {
        var $0 = {};
        $0['NB.2.1-1'] = 'Current Activity is already defined / Sequencing session has already begun';
        $0['NB.2.1-2'] = 'Current Activity is not defined / Sequencing session has not begun';
        $0['NB.2.1-3'] = 'Suspended Activity is not defined';
        $0['NB.2.1-4'] = 'Flow Sequencing Control Mode violation';
        $0['NB.2.1-5'] = 'Flow or Forward Only Sequencing Control Mode violation';
        $0['NB.2.1-6'] = 'No activity is \'previous\' to the root';
        $0['NB.2.1-7'] = 'Unsupported navigation request';
        $0['NB.2.1-8'] = 'Choice Exit Sequencing Control Mode violation';
        $0['NB.2.1-9'] = 'No activities to consider';
        $0['NB.2.1-10'] = 'Choice Sequencing Control Mode violation';
        $0['NB.2.1-11'] = 'Target activity does not exist';
        $0['NB.2.1-12'] = 'Current Activity already terminated';
        $0['NB.2.1-13'] = 'Undefined navigation request';
        $0['TB.2.3-1'] = 'Current Activity is not defined / Sequencing session has not begun';
        $0['TB.2.3-2'] = 'Current Activity already terminated';
        $0['TB.2.3-3'] = 'Cannot suspend an inactive root';
        $0['TB.2.3-4'] = 'Activity tree root has no parent';
        $0['TB.2.3-5'] = 'Nothing to suspend; No active activities';
        $0['TB.2.3-6'] = 'Nothing to abandon; No active activities';
        $0['TB.2.3-7'] = 'Undefined termination request';
        $0['SB.2.1-1'] = 'Last activity in the tree';
        $0['SB.2.1-2'] = 'Cluster has no available children';
        $0['SB.2.1-3'] = 'No activity is \'previous\' to the root';
        $0['SB.2.1-4'] = 'Forward Only Sequencing Control Mode violation';
        $0['SB.2.2-1'] = 'Flow Sequencing Control Mode violation';
        $0['SB.2.2-2'] = 'Activity unavailable';
        $0['SB.2.4-1'] = 'Forward Traversal Blocked';
        $0['SB.2.4-2'] = 'Forward Only Sequencing Control Mode violation';
        $0['SB.2.4-3'] = 'No activity is \'previous\' to the root';
        $0['SB.2.5-1'] = 'Current Activity is defined / Sequencing session already begun';
        $0['SB.2.6-1'] = 'Current Activity is defined / Sequencing session already begun';
        $0['SB.2.6-2'] = 'No Suspended Activity defined';
        $0['SB.2.7-1'] = 'Current Activity is not defined / Sequencing session has not begun';
        $0['SB.2.7-2'] = 'Flow Sequencing Control Mode violation';
        $0['SB.2.8-1'] = 'Current Activity is not defined / Sequencing session has not begun';
        $0['SB.2.8-2'] = 'Flow Sequencing Control Mode violation';
        $0['SB.2.9-1'] = 'No target for Choice';
        $0['SB.2.9-2'] = 'Target activity does not exist or is unavailable';
        $0['SB.2.9.3'] = 'Target activity hidden from choice';
        $0['SB.2.9-4'] = 'Choice Sequencing Control Mode violation';
        $0['SB.2.9-5'] = 'No activities to consider';
        $0['SB.2.9-6'] = 'Unable to activate target; target is not a child of the Current Activity';
        $0['SB.2.9-7'] = 'Choice Exit Sequencing Control Mode violation';
        $0['SB.2.9-8'] = 'Unable to choose target activity \ufffd constrained choice';
        $0['SB.2.9-9'] = 'Choice request prevented by Flow-only activity';
        $0['SB.2.10-1'] = 'Current Activity is not defined / Sequencing session has not begun';
        $0['SB.2.10-2'] = 'Current Activity is active or suspended';
        $0['SB.2.10-3'] = 'Flow Sequencing Control Mode violation';
        $0['SB.2.11-1'] = 'Current Activity is not defined / Sequencing session has not begun';
        $0['SB.2.11-2'] = 'Current Activity has not been terminated';
        $0['SB.2.12-1'] = 'Undefined sequencing request';
        $0['SB.2.13-1'] = 'Current Activity is not defined / Sequencing session has not begun';
        $0['DB.1.1-1'] = 'Cannot deliver a non-leaf activity';
        $0['DB.1.1-2'] = 'Nothing to deliver';
        $0['DB.1.1-3'] = 'Activity unavailable';
        $0['DB.2-1'] = 'Identified activity is already active';
        if (!isUndefined($0[$p0])) {
            return $0[$p0];
        } else {
            return null;
    ...
    $47: function () {
        ...
        if (this.get_$31() !== 0) {
            this.$4A();
            if (this.get_$31() === 1) {
                this.onEventSCO(new API_BASE.BaseActivityTreeNodeEventArgs(null, 4));
                return;
            }
            if (this.get_$3F() === 1) {
                this.set_$2B(null);
                this.onEventSCO(new API_BASE.BaseActivityTreeNodeEventArgs(null, 5));
                return;
            }
        ...
        switch (this.get_$29()) {
            case 2:
                if (this.get_$2B() == null) {
                    ...
                    API_BASE.LOG.displayMessage('[NB.2.1] Navigation Request Process', this.get_$45(), this.$46(this.get_$45()));
                    return;
                }
            case 3:
                if (this.get_$2B() == null) {
            ...
            case 7:
                ...
                return;
            case 8:
                var $0 = this.findNode(this.get_$39());
                if ($0 != null) {
                    if ($0 === this.getOrganization() || $0.getParentSequencing().choice) {
                        if (this.get_$2B() == null) {
                            this.set_$29(1);
                            this.set_$2F(0);
                            this.set_$31(7);
                        ...
                        if (!$0.isSibling(this.get_$2B())) {
                            var $2 = this.findCommonParent(this.get_$2B(), $0);
                            var $3 = this.get_$2B().getPath($2, true, false, false);
                            if ($3.length > 0) {
                                var $enum1 = $3.getEnumerator();
                                while ($enum1.moveNext()) {
                                    var $4 = $enum1.get_current();
                                    if ($4.get_isActive() && !$4.getSequencing().choiceExit) {
                                        this.set_$29(0);
                                        this.set_$2F(0);
                                        this.set_$31(0);
                                        this.set_$37(null);
            ...
            case 14:
                var $1 = this.findNode(this.get_$39());
                if ($1 != null && $1.isAvailableChildren()) {
                    this.set_$29(1);
                    this.set_$2F(3);
                    this.set_$31(9);
                    this.set_$37($1);
    ...
    $49: function () {
        if (this.get_$2B() == null) {
            ...
            API_BASE.LOG.displayMessage('[TB.2.3] Termination Request Process', this.get_$45(), this.$46(this.get_$45()));
            return;
        }
        ...
        switch (this.get_$2F()) {
            ...
            case 7:
                ...
                while ($enum1.moveNext()) {
                    ...
                    $3.set_isActive(false);
                    $3.set_isSuspended(true);
                }
                this.set_$2B(this.getOrganization());
                this.set_$2F(2);
                this.set_$31(8);
    ...
    $4A: function () {
        ...
        API_BASE.LOG.displayMessage('[SB.2.12] Sequencing Request Process', this.get_$45(), this.$46(this.get_$45()));
    },
    $4B: function () {
        if (this.get_$2B() != null) {
            this.set_$2D(null);
            this.set_$45('SB.2.6-1');
            API_BASE.LOG.displayMessage('[SB.2.6] Resume All Sequencing Request Process', this.get_$45(), this.$46(this.get_$45()));
            return;
        }
        if (this.get_$3D() == null) {
            this.set_$2D(null);
    ...
    $4C: function () {
        if (this.get_$2B() == null) {
            ...
            API_BASE.LOG.displayMessage('[SB.2.11] Exit Sequencing Request Process', this.get_$45(), this.$46(this.get_$45()));
            return;
        }
        if (this.get_$2B().get_isActive()) {
            this.set_$3F(2);
    ...
    $4D: function () {
        if (this.get_$2B() == null) {
            ...
            API_BASE.LOG.displayMessage('[SB.2.10] Retry Sequencing Request Process', this.get_$45(), this.$46(this.get_$45()));
            return;
        }
        if (this.get_$2B().get_isActive() || this.get_$2B().get_isSuspended()) {
            this.set_$2D(null);
    ...
    $4E: function () {
        if (this.get_$2B() == null) {
            ...
            API_BASE.LOG.displayMessage('[SB.2.7] Continue Sequencing Request Process', this.get_$45(), this.$46(this.get_$45()));
            return;
        }
        if (this.get_$2B() !== this.getOrganization()) {
    ...
    $4F: function () {
        if (this.get_$2B() == null) {
            ...
            API_BASE.LOG.displayMessage('[SB.2.8] Previous Sequencing Request Process', this.get_$45(), this.$46(this.get_$45()));
            return;
        }
        if (this.get_$2B() !== this.getOrganization()) {
            if (!this.get_$2B().getParentSequencing().flow) {
    ...
    $50: function () {
        if (this.get_$37() == null) {
            ...
            API_BASE.LOG.displayMessage('[SB.2.9] Choice Sequencing Request Process', this.get_$45(), this.$46(this.get_$45()));
            return;
        }
        ...
        while ($enum1.moveNext()) {
            var $3 = $enum1.get_current();
            if ($3 !== this.getOrganization()) {
                if (!$3.isAvailableChildren()) {
                    this.set_$2D(null);
            ...
            var $4 = this.$57($3.getSequencing().getConditionRulesForAction('hiddenFromChoice'), $3);
            if ($4 != null) {
                this.set_$2D(null);
        ...
        if (this.get_$2B() === this.get_$37()) { }
        else if (this.get_$2B() != null && this.get_$2B().isSibling(this.get_$37())) {
            ...
            var $6;
            if (this.get_$37().getOrderIndex() > this.get_$2B().getOrderIndex()) {
                $6 = true;
            } else {
                $6 = false;
            }
            ...
            while ($enum5.moveNext()) {
                var $12 = $enum5.get_current();
                if (!$12.getSequencing().choiceExit) {
                    this.set_$2D(null);
                    this.set_$45('SB.2.9-7');
                    API_BASE.LOG.displayMessage('[SB.2.9] Choice Sequencing Request Process', this.get_$45(), this.$46(this.get_$45()));
                    return;
                ...
                if ($F == null) {
                    if ($12.getSequencing().constrainedChoiceConsiderations_constrainChoice) {
                        $F = $12;
                    }
                }
            }
            if ($F != null) {
                var $13;
                if (this.get_$37().getOrderIndex() > $F.getOrderIndex()) {
                    $13 = true;
                } else {
                    $13 = false;
                }
    ...
    $51: function ($p0, $p1) {
        if ($p1) {
            ...
            if ($0 != null) {
                ...
                API_BASE.LOG.displayMessage('[SB.2.4] Choice Activity Traversal Subprocess', this.get_$45(), this.$46(this.get_$45()));
                return this.get_$43();
            }
            this.set_$43(true);
            this.set_$45(null);
    ...
    $54: function () {
        if (this.get_$2B() == null) {
            ...
            API_BASE.LOG.displayMessage('[SB.2.13] Jump Sequencing Request Process', this.get_$45(), this.$46(this.get_$45()));
            return;
        }
        this.set_$2D(this.get_$37());
        this.set_$45(null);
    ...
    $67: function () {
        if (!this.get_$2D().isLeaf()) {
            ...
            API_BASE.LOG.displayMessage('[DB.1.1] Delivery Request Process', this.get_$45(), this.$46(this.get_$45()));
            return false;
        }
    ...
    $68: function () {
        if (this.get_$2B() != null && this.get_$2B().get_isActive()) {
            this.set_$45('DB.2-1');
            API_BASE.LOG.displayMessage('[DB.2] Content Delivery Environment Process', this.get_$45(), this.$46(this.get_$45()));
            return;
        }
        if (this.get_$2B() != null) {
        ...
        if (!this.$24) {
            ...
            this.$23 = this.$77();
            this.onEventSCO(new API_BASE.BaseActivityTreeNodeEventArgs(this.get_$2D(), 2));
        }
    },
    $69: function ($p0) {
        if (this.get_$3D() != null) {
    ...
    $6A: function () {
        if (this.get_$2B() != null) {
            ...
            API_BASE.LOG.displayMessage('[SB.2.5] Start Sequencing Request Process', this.get_$45(), this.$46(this.get_$45()));
        }
        ...
        if ($p1 === 1) {
            ...
            if ($p0.isLeaf() || !$p3) {
                ...
                if ($p0.getChildrensCount() > 0) {
                    ...
                    API_BASE.LOG.displayMessage('[SB.2.1] Flow Tree Traversal Subprocess', this.get_$45(), this.$46(this.get_$45()));
                    return;
                }
            }
        }
    ...
    $6D: function ($p0, $p1, $p2) {
        if (!$p0.getParentSequencing().flow) {
            ...
            API_BASE.LOG.displayMessage('[SB.2.2] Flow Activity Traversal Subprocess', this.get_$45(), this.$46(this.get_$45()));
            return;
        }
    ...
    initByManifest: function (manifestPath, imsmanifest) {
        ...
        var $0 = API_BASE.BaseUtils.getChildNodeByName(imsmanifest, 'manifest');
        if ($0 == null) {
            return;
        }
        var $1 = API_BASE.BaseUtils.getChildNodeByName($0, 'organizations');
        if ($1 == null) {
            return;
        }
        var $2 = API_BASE.BaseUtils.getXMLNodeAttribut($0, 'base');
        ...
        var $3 = API_BASE.BaseUtils.getChildSiblingsByName($1, 'organization');
        if ($3 == null || $3.length <= 0) {
            return;
        }
        var $4 = API_BASE.BaseUtils.getChildNodeByName($0, 'resources');
        var $5 = null;
        var $6 = '';
        if ($4 != null) {
            var $A = API_BASE.BaseUtils.getXMLNodeAttribut($4, 'base');
            ...
            if (!isNullOrUndefined($A)) {
                if (!$A.startsWith('/')) {
                    ...
                    $6 = API_BASE.BaseUtils.getBaseOfUrl($6) + $A;
                }
            }
            $5 = API_BASE.BaseUtils.getChildSiblingsByName($4, 'resource');
        }
        var $7 = API_BASE.BaseUtils.getChildNodeByName($0, 'sequencingCollection');
        var $8 = false;
        if (!isNullOrUndefined(this.$17) && this.$17.length > 0) {
            var $enum1 = $3.getEnumerator();
            while ($enum1.moveNext()) {
                var $B = $enum1.get_current();
                var $C = API_BASE.BaseUtils.getXMLNodeAttribut($B, 'identifier');
                if ($C === this.$17) {
                    $8 = true;
        ...
        var $9 = this.getActivityTreeNodes();
        var $dict2 = $9;
    ...
    $73: function ($p0, $p1, $p2, $p3, $p4, $p5) {
        var $0 = API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'identifier');
        var $1 = null;
        var $2 = null;
        var $3 = true;
        var $4 = null;
        if (!$p5) {
            $1 = API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'identifierref');
            if ($1 != null && $1.length > 0 && !isNullOrUndefined($p2) && $p2.length >= 1) {
                var $enum1 = $p2.getEnumerator();
                while ($enum1.moveNext()) {
                    var $6 = $enum1.get_current();
                    var $7 = API_BASE.BaseUtils.getXMLNodeAttribut($6, 'identifier');
                    if ($7 != null && $7 === $1) {
                        $4 = API_BASE.BaseUtils.getXMLNodeAttribut($6, 'scormType');
                        if (!isNullOrUndefined($4)) {
                            $4 = $4.toLowerCase();
                        }
                        $2 = API_BASE.BaseUtils.getXMLNodeAttribut($6, 'href');
                        if ($2 == null) {
                            $2 = '';
                        }
                        while ($2.startsWith('/')) {
                        ...
                        var $8 = API_BASE.BaseUtils.getXMLNodeAttribut($6, 'base');
                        if ($8 != null && $8.length > 0 && !$2.startsWith('http://') && !$2.startsWith('https://')) {
                            ...
                            if (!$8.startsWith('/')) {
                                ...
                                $p4 = API_BASE.BaseUtils.getBaseOfUrl($p4) + $8;
                            }
                        }
                        $2 = $p4 + $2;
                        while ($2.startsWith('/')) {
                        ...
                        $2 = API_BASE.BaseUtils.utf8Decode($2);
                        var $9 = API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'parameters');
                        if ($9 == null || $9.length <= 0) {
                            break;
                        }
                        $2 = API_BASE.BaseUtils.addParameters($2, $9);
                        break;
                    }
                }
            }
            $3 = API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'isvisible') == null || API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'isvisible') === 'true';
        } else {
            this.$1E = API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'sharedDataGlobalToSystem') == null || API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'sharedDataGlobalToSystem') === 'true';
            this.$1F = API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'objectivesGlobalToSystem') == null || API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'objectivesGlobalToSystem') === 'true';
            if (!this.$1F) {
                if (this.$1D == null) {
                    this.$20 = {};
                }
        ...
        for (var $A = 0; $A < $p1.childNodes.length; $A++) {
            ...
            var $B = API_BASE.BaseUtils.getBaseName($p1.childNodes[$A]).toLowerCase();
            var $C = API_BASE.BaseUtils.getText($p1.childNodes[$A]);
            if ($B === 'title') {
                $5.setTitle($C);
            } else if ($B === 'item') {
                ...
                $5.setCompletedbymeasure(API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$A], 'completedByMeasure') != null && API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$A], 'completedByMeasure') === 'true');
                if (API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$A], 'minProgressMeasure') != null) {
                    $5.setMinprogressmeasure(parseFloat(API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$A], 'minProgressMeasure')));
                }
                if (API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$A], 'progressWeight') != null) {
                    $5.setProgressweight(parseFloat(API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$A], 'progressWeight')));
                }
            } else if ($B === 'data') {
                var $D;
                ...
                for (var $E = 0; $E < $p1.childNodes[$A].childNodes.length; $E++) {
                    ...
                    var $10 = API_BASE.BaseUtils.getBaseName($F).toLowerCase();
                    if ($10 !== 'map') {
                        continue;
                    }
                    if (API_BASE.BaseUtils.getXMLNodeAttribut($F, 'targetID') == null) {
                        continue;
                    }
                    var $11 = API_BASE.BaseUtils.getXMLNodeAttribut($F, 'targetID');
                    if ($11.length <= 0) {
                        continue;
                    }
                    ...
                    var $12 = true;
                    if (API_BASE.BaseUtils.getXMLNodeAttribut($F, 'readSharedData') != null) {
                        $12 = API_BASE.BaseUtils.getXMLNodeAttribut($F, 'readSharedData') === 'true';
                    }
                    var $13 = true;
                    if (API_BASE.BaseUtils.getXMLNodeAttribut($F, 'writeSharedData') != null) {
                        $13 = API_BASE.BaseUtils.getXMLNodeAttribut($F, 'writeSharedData') === 'true';
                    }
                    $D[$11] = {
                        readSharedData: $12,
                        writeSharedData: $13,
                ...
                var $14 = API_BASE.BaseUtils.getChildNodeByName($p1.childNodes[$A], 'navigationInterface');
                if (!isNullOrUndefined($14)) {
                    ...
                    for (var $16 = 0; $16 < $14.childNodes.length; $16++) {
                        ...
                        var $18 = API_BASE.BaseUtils.getBaseName($17).toLowerCase();
                        if ($18 !== 'hidelmsui' || isNullOrUndefined(API_BASE.BaseUtils.getText($17))) {
                            continue;
                        }
                        var $19 = API_BASE.BaseUtils.getText($17).trim().toLowerCase();
                        if (!$15.contains($19)) {
                            $15.add($19);
                        }
                    }
    ...
    $74: function ($p0, $p1, $p2) {
        var $0 = API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'IDRef');
        if ($0 != null && $p2 != null) {
            for (var $2 = 0; $2 < $p2.childNodes.length; $2++) {
                if ($p2.childNodes[$2].nodeType !== 1) {
                    continue;
                }
                var $3 = API_BASE.BaseUtils.getXMLNodeAttribut($p2.childNodes[$2], 'ID');
                if ($0 === $3) {
        ...
        var $1 = API_BASE.BaseUtils.getChildSiblingsByName($p1, 'objectives');
        var $enum1 = $1.getEnumerator();
        while ($enum1.moveNext()) {
            var $4 = $enum1.get_current();
            var $5 = API_BASE.BaseUtils.getChildNodeByName($4, 'primaryObjective');
            if ($5 != null) {
                $p0.getSequencing().createObjectives(API_BASE.BaseUtils.getXMLNodeAttribut($5, 'objectiveID'));
                var $6 = API_BASE.BaseUtils.getXMLNodeAttribut($5, 'satisfiedByMeasure');
                if ($6 === 'true') {
                    $p0.getSequencing().getPrimaryObjective().satisfiedByMeasure = true;
                    var $7 = API_BASE.BaseUtils.getChildNodeByName($5, 'minNormalizedMeasure');
                    var $8 = '1.0';
                    if ($7 != null && API_BASE.BaseUtils.getText($7).trim().length > 0) {
                        $8 = API_BASE.BaseUtils.getText($7).trim();
                    }
                    $p0.getSequencing().getPrimaryObjective().minNormalizedMeasure = parseFloat($8);
                }
                this.$75(API_BASE.BaseUtils.getChildSiblingsByName($5, 'mapInfo'), $p0.getSequencing().getPrimaryObjective());
                break;
            }
        }
        for (var $9 = 0; $9 < $p1.childNodes.length; $9++) {
            ...
            var $A = API_BASE.BaseUtils.getBaseName($p1.childNodes[$9]).toLowerCase();
            if ($A === 'controlmode') {
                var $B = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'choice');
                $p0.getSequencing().choice = $B === 'true' || $B == null;
                var $C = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'choiceExit');
                $p0.getSequencing().choiceExit = $C === 'true' || $C == null;
                var $D = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'flow');
                $p0.getSequencing().flow = $D === 'true';
                var $E = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'forwardOnly');
                $p0.getSequencing().forwardOnly = $E === 'true';
                var $F = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'useCurrentAttemptObjectiveInfo');
                $p0.getSequencing().useCurrentAttemptObjectiveInfo = $F === 'true' || $F == null;
                var $10 = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'useCurrentAttemptProgressInfo');
                ...
                var $11 = API_BASE.BaseUtils.getChildSiblingsByName($p1.childNodes[$9], 'objective');
                var $enum2 = $11.getEnumerator();
                while ($enum2.moveNext()) {
                    var $12 = $enum2.get_current();
                    var $13 = API_BASE.BaseUtils.getXMLNodeAttribut($12, 'objectiveID');
                    if ($13 != null) {
                    ...
                    var $16 = API_BASE.BaseUtils.getXMLNodeAttribut($12, 'satisfiedByMeasure');
                    if ($16 === 'true') {
                        $15.satisfiedByMeasure = true;
                        var $17 = API_BASE.BaseUtils.getChildNodeByName($12, 'minNormalizedMeasure');
                        var $18 = '1.0';
                        if ($17 != null && API_BASE.BaseUtils.getText($17).trim().length > 0) {
                            $18 = API_BASE.BaseUtils.getText($17).trim();
                        }
                        $15.minNormalizedMeasure = parseFloat($18);
                    }
                    this.$75(API_BASE.BaseUtils.getChildSiblingsByName($12, 'mapInfo'), $15);
                }
            } else if ($A === 'randomizationcontrols') {
                var $19 = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'randomizationTiming');
                if (!isNullOrUndefined($19)) {
                    $p0.getSequencing().randomizationTiming = $19;
                }
                var $1A = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'selectCount');
                if (!isNullOrUndefined($1A) && $1A.length > 0) {
                    $p0.getSequencing().selectCount = parseInt($1A);
                }
                var $1B = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'reorderChildren');
                if (!isNullOrUndefined($1B)) {
                    $p0.getSequencing().reorderChildren = $1B === 'true';
                }
                var $1C = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'selectionTiming');
                if (!isNullOrUndefined($1C)) {
                    $p0.getSequencing().selectionTiming = $1C;
                }
            } else if ($A === 'deliverycontrols') {
                var $1D = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'tracked');
                $p0.getSequencing().tracked = $1D == null || $1D === 'true';
                $p0.getSequencing().manifestCompletionSetByContent = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'completionSetByContent') === 'true';
                $p0.getSequencing().manifestObjectiveSetByContent = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'objectiveSetByContent') === 'true';
                ...
                var $1E = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'rollupObjectiveSatisfied');
                var $1F = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'rollupProgressCompletion');
                var $20 = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'objectiveMeasureWeight');
                $p0.getSequencing().rollupObjectiveSatisfied = ($1E === 'false') ? false : true;
                $p0.getSequencing().rollupProgressCompletion = ($1F === 'false') ? false : true;
                $p0.getSequencing().rollupObjectiveMeasureWeight = parseFloat(($20 == null || $20.length === 0) ? '1.0000' : $20);
                var $21 = API_BASE.BaseUtils.getChildSiblingsByName($p1.childNodes[$9], 'rollupRule');
                var $enum3 = $21.getEnumerator();
                while ($enum3.moveNext()) {
                    var $22 = $enum3.get_current();
                    var $23 = API_BASE.BaseUtils.getChildNodeByName($22, 'rollupAction');
                    var $24 = API_BASE.BaseUtils.getChildNodeByName($22, 'rollupConditions');
                    if ($24 == null || $23 == null) {
                        continue;
                    }
                    var $25 = {};
                    var $26 = API_BASE.BaseUtils.getXMLNodeAttribut($22, 'childActivitySet');
                    $25['childActivitySet'] = ($26 == null || $26.length === 0) ? 'all' : $26;
                    var $27 = API_BASE.BaseUtils.getXMLNodeAttribut($22, 'minimumCount');
                    $25['minimumCount'] = ($27 == null || $27.length === 0) ? '0' : $27;
                    var $28 = API_BASE.BaseUtils.getXMLNodeAttribut($22, 'minimumPercent');
                    $25['minimumPercent'] = ($28 == null || $28.length === 0) ? '0.0000' : $28;
                    var $29 = API_BASE.BaseUtils.getXMLNodeAttribut($24, 'conditionCombination');
                    $25['action'] = API_BASE.BaseUtils.getXMLNodeAttribut($23, 'action');
                    $25['conditionCombination'] = ($29 == null) ? 'any' : $29;
                    var $2A = API_BASE.BaseUtils.getChildSiblingsByName($24, 'rollupCondition');
                    var $2B = 0;
                    var $enum4 = $2A.getEnumerator();
                    while ($enum4.moveNext()) {
                        var $2C = $enum4.get_current();
                        var $2D = API_BASE.BaseUtils.getXMLNodeAttribut($2C, 'operator');
                        $25['rule_' + $2B] = {
                            condition: API_BASE.BaseUtils.getXMLNodeAttribut($2C, 'condition'),
                ...
                $p0.getSequencing().limitConditions_attemptLimit = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'attemptLimit');
                ...
                $p0.getSequencing().limitConditions_attemptAbsoluteDurationLimit = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'attemptAbsoluteDurationLimit');
                ...
                $p0.getSequencing().constrainedChoiceConsiderations_preventActivation = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'preventActivation') === 'true';
                $p0.getSequencing().constrainedChoiceConsiderations_constrainChoice = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'constrainChoice') === 'true';
            } else if ($A === 'rollupconsiderations') {
                var $2E = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'requiredForSatisfied');
                $p0.getSequencing().rollupConsiderations_requiredForSatisfied = ($2E == null) ? 'always' : $2E;
                var $2F = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'requiredForNotSatisfied');
                $p0.getSequencing().rollupConsiderations_requiredForNotSatisfied = ($2F == null) ? 'always' : $2F;
                var $30 = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'requiredForCompleted');
                $p0.getSequencing().rollupConsiderations_requiredForCompleted = ($30 == null) ? 'always' : $30;
                var $31 = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'requiredForIncomplete');
                $p0.getSequencing().rollupConsiderations_requiredForIncomplete = ($31 == null) ? 'always' : $31;
                var $32 = API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$9], 'measureSatisfactionIfActive');
    ...
    $75: function ($p0, $p1) {
        ...
        while ($enum1.moveNext()) {
            var $1 = $enum1.get_current();
            var $2 = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'targetObjectiveID');
            if ($2 == null) {
                continue;
            }
            $2 = SCORM_1_3.Utils.removeWhiteSpaces(decodeURI($2.trim()));
            var $3 = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'readSatisfiedStatus');
            var $4 = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'readNormalizedMeasure');
            var $5 = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'writeSatisfiedStatus');
            var $6 = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'writeNormalizedMeasure');
            var $7 = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'readRawScore');
            var $8 = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'readMinScore');
            var $9 = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'readMaxScore');
            var $A = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'readCompletionStatus');
            var $B = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'readProgressMeasure');
            var $C = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'writeRawScore');
            var $D = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'writeMinScore');
            var $E = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'writeMaxScore');
            var $F = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'writeCompletionStatus');
            var $10 = API_BASE.BaseUtils.getXMLNodeAttribut($1, 'writeProgressMeasure');
            if ($0[$2] == null) {
                $0[$2] = {};
            }
            ($0[$2])['readSatisfiedStatus'] = ($3 === 'false') ? false : true;
            ($0[$2])['readNormalizedMeasure'] = ($4 === 'false') ? false : true;
            ($0[$2])['writeSatisfiedStatus'] = ($5 === 'true') ? true : false;
            ($0[$2])['writeNormalizedMeasure'] = ($6 === 'true') ? true : false;
            ($0[$2])['readRawScore'] = ($7 === 'false') ? false : true;
            ($0[$2])['readMinScore'] = ($8 === 'false') ? false : true;
            ($0[$2])['readMaxScore'] = ($9 === 'false') ? false : true;
            ($0[$2])['readCompletionStatus'] = ($A === 'false') ? false : true;
            ($0[$2])['readProgressMeasure'] = ($B === 'false') ? false : true;
            ($0[$2])['writeRawScore'] = ($C === 'true') ? true : false;
            ($0[$2])['writeMinScore'] = ($D === 'true') ? true : false;
            ($0[$2])['writeMaxScore'] = ($E === 'true') ? true : false;
            ($0[$2])['writeCompletionStatus'] = ($F === 'true') ? true : false;
            ($0[$2])['writeProgressMeasure'] = ($10 === 'true') ? true : false;
            if (!Object.keyExists(this.$20, $2)) {
    ...
    $76: function ($p0, $p1) {
        var $0 = [];
        var $1 = API_BASE.BaseUtils.getChildSiblingsByName($p0, $p1);
        var $enum1 = $1.getEnumerator();
        while ($enum1.moveNext()) {
            var $2 = $enum1.get_current();
            var $3 = API_BASE.BaseUtils.getChildNodeByName($2, 'ruleAction');
            var $4 = API_BASE.BaseUtils.getChildNodeByName($2, 'ruleConditions');
            if ($4 == null || $3 == null) {
                continue;
            }
            var $5 = API_BASE.BaseUtils.getXMLNodeAttribut($4, 'conditionCombination');
            var $6 = {};
            $6['action'] = API_BASE.BaseUtils.getXMLNodeAttribut($3, 'action');
            $6['conditionCombination'] = ($5 == null) ? 'all' : $5;
            var $7 = API_BASE.BaseUtils.getChildSiblingsByName($4, 'ruleCondition');
            var $8 = 0;
            var $enum2 = $7.getEnumerator();
            while ($enum2.moveNext()) {
                var $9 = $enum2.get_current();
                var $A = API_BASE.BaseUtils.getXMLNodeAttribut($9, 'operator');
                var $B = API_BASE.BaseUtils.getXMLNodeAttribut($9, 'referencedObjective');
                if ($B != null) {
                    $B = SCORM_1_3.Utils.removeWhiteSpaces(decodeURI($B.trim()));
                }
                $6['rule_' + $8] = {
                    referencedObjective: $B,
                    measureThreshold: API_BASE.BaseUtils.getXMLNodeAttribut($9, 'measureThreshold'),
                    condition: API_BASE.BaseUtils.getXMLNodeAttribut($9, 'condition'),
...
SCORM_1_3.API_1484_11_LIB = function (activityTreeNode) {
    ...
    this.$17 = '^previous$|^continue$|^exit$|^exitAll$|^abandon$|^abandonAll$|^suspendAll$|^{target=' + API_BASE.BaseUtils.ncName + '}choice$|^{target=' + API_BASE.BaseUtils.ncName + '}jump$|^_none_$';
    this.$18 = '^unknown$|^true$|^false$';
    this.$19 = '^previous$|^continue$|^choice.{target=' + API_BASE.BaseUtils.ncName + '}$|^jump.{target=' + API_BASE.BaseUtils.ncName + '}$';
...
SCORM_1_3.API_1484_11_LIB.prototype = {
    ...
    Initialize: function (param) {
        ...
        if (param === '') {
            if ((!this.$2D) && (!this.$2E)) {
                ...
                API_BASE.LOG.displayMessage('Initialize with param: \'' + param + '\'', this.$30, this.$32(this.$30));
                return 'true';
            } else {
                if (this.$2D) {
                    this.$30 = '103';
    ...
    Terminate: function (param) {
        ...
        if (param === '') {
            if (this.$2D && (!this.$2E)) {
                API_BASE.LOG.displayMessage('Terminate with param: \'' + param + '\'', this.$30, this.$32(this.$30));
                this.$2D = false;
                this.$2E = true;
                ...
                if (this.$2C.getRoot() != null) {
                    ...
                    this.$2C.getRoot().onEventSCO(new API_BASE.BaseActivityTreeNodeEventArgs(this.$2C, 1));
                }
                if (!$1) {
                ...
                if (this.$2C.getRoot() != null) {
                    ...
                    var $5 = this.$2C.getRoot().getActivityTreeNodes();
                    var $dict3 = $5;
                    for (var $key4 in $dict3) {
                        var $6 = {
                            key: $key4,
                    ...
                    this.$2C.getRoot().onEventSCO(new API_BASE.BaseActivityTreeNodeEventArgs(this.$2C, 0));
    ...
    GetValue: function (element) {
                    ...
                    if ((Type.safeCast(this.$2A[$1], Object))['mod'] !== 'w') {
                        ...
                        if (this.$30 === '0') {
                            ...
                            if (!isNullOrUndefined($5)) {
                                this.$30 = '0';
                                API_BASE.LOG.displayMessage('GetValue ' + element + ', \'' + $5 + '\'', this.$30, this.$32(this.$30));
                                return $5;
                            } else if (isNull($5)) {
                                this.$30 = '403';
                            } else {
                    ...
                    if ($1.substr($1.length - $6.length, $1.length) === $6) {
                        ...
                        if (element.substr(0, $8.length) === $8) {
                            if (element.substr($8.length).match(new RegExp(this.$19)) == null) {
                                ...
                                API_BASE.LOG.displayMessage('GetValue ' + element + ', \'' + $9 + '\'', '0', null);
                                return $9;
                            }
                        } else {
                            this.$30 = '401';
        ...
        API_BASE.LOG.displayMessage('GetValue ' + element + ', \'\'', this.$30, this.$32(this.$30));
        return '';
    },
                        ...
                        if (this.$30 === '0') {
                            ...
                            if (($6 != null) && (($6.join('').length > 0) || (value.length === 0))) {
                                ...
                                if (this.$30 === '0' && element !== $1) {
                                    ...
                                    var $9 = $7[0];
                                    var $A = false;
                                    for (var $B = 1; ($B < $7.length - 1) && (this.$30 === '0'); $B++) {
                                        var $C = $7[$B];
                                    ...
                                    if (!isUndefined((this.$2A[$1])['range'])) {
                                        ...
                                        if ($15 >= parseFloat($14[0])) {
                                            if (($14[1] === '*') || ($15 <= parseFloat($14[1]))) {
                                                ...
                                                this.$30 = '0';
                                                API_BASE.LOG.displayMessage('SetValue ' + element + ', \'' + value + '\'', this.$30, this.$32(this.$30));
                                                return 'true';
                                            } else {
                                                this.$30 = '407';
                                            }
    ...
    Commit: function (param) {
        say("API_1484_11 Commit() was called")
        this.$30 = '0';
        this.$2F = '';
        if (isNullOrUndefined(param)) {
            param = '';
        ...
        if (param === '') {
            if (this.$2D && (!this.$2E)) {
                ...
                API_BASE.LOG.displayMessage('Commit with param: \'' + param + '\'', this.$30, this.$32(this.$30));
                return 'true';
            } else {
                if (this.$2E) {
                    this.$30 = '143';
    ...
    GetLastError: function () {
        API_BASE.LOG.displayMessage('GetLastError, Error Code: ' + this.$30, '0', null);
        return this.$30;
    },
    GetErrorString: function (param) {
        if (param !== '') {
            ...
            if (!isNullOrUndefined($0)) {
                API_BASE.LOG.displayMessage('GetErrorString with param: \'' + param + '\', Error String: ' + $0, '0', null);
                return $0;
            }
        }
        API_BASE.LOG.displayMessage('GetErrorString with param: \'' + param + '\', No error string found!', '0', null);
        return '';
    },
    $32: function ($p0) {
        var $0 = {};
        $0['0'] = 'No Error';
        $0['101'] = 'General Exception';
        $0['102'] = 'General Inizialization Failure';
        $0['103'] = 'Already Initialized';
        $0['104'] = 'Content Instance Terminated';
        $0['111'] = 'General Termination Failure';
        $0['112'] = 'Termination Before Inizialization';
        $0['113'] = 'Termination After Termination';
        $0['122'] = 'Retrieve Data Before Initialization';
        $0['123'] = 'Retrieve Data After Termination';
        $0['132'] = 'Store Data Before Inizialization';
        $0['133'] = 'Store Data After Termination';
        $0['142'] = 'Commit Before Inizialization';
        $0['143'] = 'Commit After Termination';
        $0['201'] = 'General Argument Error';
        $0['301'] = 'General Get Failure';
        $0['351'] = 'General Set Failure';
        $0['391'] = 'General Commit Failure';
        $0['401'] = 'Undefinited Data Model Element';
        $0['402'] = 'Unimplemented Data Model Element';
        $0['403'] = 'Data Model Element Value Not Initialized';
        $0['404'] = 'Data Model Element Is Read Only';
        $0['405'] = 'Data Model Element Is Write Only';
        $0['406'] = 'Data Model Element Type Mismatch';
        $0['407'] = 'Data Model Element Value Out Of Range';
        $0['408'] = 'Data Model Dependency Not Established';
        if (!isUndefined($0[$p0])) {
            return $0[$p0];
        } else {
            return null;
    ...
    GetDiagnostic: function (param) {
        ...
        if (param === '') {
            param = this.$30;
            if (this.$2F !== '') {
                API_BASE.LOG.displayMessage('GetDiagnostic with param: \'' + param + '\' Diagnostic: ' + this.$2F, '0', null);
                return this.$2F;
            }
        }
        API_BASE.LOG.displayMessage('GetDiagnostic with param: \'' + param + '\'', '0', null);
    ...
    $36: function ($p0, $p1, $p2, $p3) {
        ...
        if (($0.length > 0) && ($0.length <= parseInt($p3['max']))) {
            ...
            for (var $2 = 0; ($2 < $0.length) && (this.$30 === '0'); $2++) {
                if (($p3['pre']).length > 0) {
...
SCORM_1_3.Utils.getTimeComparableValue = function (time) {
    ...
    $0 += $7 * 30 * 24 * 60 * 60 * 1000;
    var $8 = 0;
    if (parseInt($2[2], 10) > 0) {
        $8 = parseInt($2[2], 10);
    }
    $0 += $8 * 365 * 30 * 24 * 60 * 60 * 1000;
    return $0;
}
...
API_1484_11.setAPI_1484_11_LIB = function (api_1484_11_lib) {
    API_1484_11.$0 = api_1484_11_lib;
}
API_1484_11.Initialize = function (param) {
    say("API_1484_11.LMSInitialize()");
    onBeforeLMSInit(2004);
    var valToReturn = API_1484_11.$0.Initialize(param);
    onAfterLMSInit();
    return valToReturn;
}
API_1484_11.Terminate = function (param) {
    say("API_1484_11.LMSFinish");
    saveLMSData();
    return API_1484_11.$0.Terminate(param);
}
API_1484_11.GetValue = function (element) {
    return API_1484_11.$0.GetValue(element);
}
API_1484_11.SetValue = function (element, value) {
    return API_1484_11.$0.SetValue(element, value);
}
API_1484_11.Commit = function (param) {
    say("API_1484_11.LMSCommit");
    saveLMSData();
    return API_1484_11.$0.Commit(param);
}
API_1484_11.GetLastError = function () {
    return API_1484_11.$0.GetLastError();
}
API_1484_11.GetErrorString = function (param) {
    return API_1484_11.$0.GetErrorString(param);
}
API_1484_11.GetDiagnostic = function (param) {
    say("API_1484_11.LMSGetDiagnostic");
    return API_1484_11.$0.GetDiagnostic(param);
}
SCORM_1_3.ActivityTreeNode.createClass('SCORM_1_3.ActivityTreeNode', null, API_BASE.IActivityTreeNode);
SCORM_1_3.ActivityTree.createClass('SCORM_1_3.ActivityTree', SCORM_1_3.ActivityTreeNode, API_BASE.IActivityTree);
...
SCORM_1_3.API_1484_11_LIB.createClass('SCORM_1_3.API_1484_11_LIB', null, API_BASE.IAPI);
