...
Player.PersistentStateStorage = function (organizationIdentifier) {
	...
	var $0 = {};
	if (!this.$0.hasKey('scormpool')) {
		$0['organizations'] = {};
		$0['globalobjectives'] = {};
	} else {
		$0 = this.$0.getObjectItem('scormpool');
	}
...
Player.PersistentStateStorage.prototype = {
	...
	getAllStatus : function () {
		var $0 = this.$0.getObjectItem('scormpool');
		var $1 = $0['organizations'];
		var $2 = $1[this.$1];
		return $2['statuses'];
	},
...
Player.ContentPlayer = function (manifestPath, imsmanifest, isStorage, isScormAuto, isDebug) {
    say("called pseudo-class Player.ContentPlayer, params:  __manifestPath:" + manifestPath +
                                                            "  __imsmanifest:" + imsmanifest +
                                                            "  __isStorage:" + isStorage +
                                                            "  __isScormAuto:" + isScormAuto +
                                                            "  __isDebug:" + isDebug);
    this.$2 = 0;
    this.$18 = [];
...
Player.ContentPlayer.prototype = {
    ...
    $1A: function () {       
        ...
        if (isNullOrUndefined(this.$3)) {
            ...
            say("player created iFrame 'contentIFrame'");
        ...
        this.$3.onload = "say('new iframe is loaded');";
    },
    $1B: function () {
        //say("in 1B - Player.ContentPlayer.prototype");
    ...
    $1C: function ($p0, $p1) {
        //say("in 1C - Player.ContentPlayer.prototype");
    ...
    $1D: function () {
        //say("in 1D - Player.ContentPlayer.prototype");
    ...
    $1E: function () {
        //say("in treeContainer - Player.ContentPlayer.prototype");
    ...
    $1F: function () {
        //say("in debuggerContainer - Player.ContentPlayer.prototype");
        if (!this.$1) {
            return;
        }
    ...
    $20: function ($p0) {
        //say("in $20 - Player.ContentPlayer.prototype");
    ...
    $21: function ($p0, $p1) {
        ...
        say("in $21 - requestNavigation.target= " + $0.getIdentifier());
    ...
    $22: function ($p0, $p1) {
        ...
        if ($p1.get_eventType() === 5 || $p1.get_eventType() === 3 || $p1.get_eventType() === 4) {
            ...
            if ($p1.get_eventType() !== 4) {
                this.$F = true;
                say("player in $22: attachEvent 'onload' at $22");
                this.$3.attachEvent('onload', this.$4);
            } else {
                if (isNullOrUndefined(this.$C)) {
                    //say("No SCO to deliver");
            ...
            if (this.$B != null) {
                ...
                if (this.$17 != null) {
                    say("about to saveItemCMI at player at $22");
    ...
    $24: function () {
        ...
        if (this.$19 < this.$18.length) {
            ...
            var $3 = this.$C;
            say("in $24 - choice.target= " + $2.getIdentifier());
    ...
    $25: function () {
        ...
        if (this.$19 < this.$18.length) {
            ...
            var $2 = $1.get_userData();
            var $3 = this.$C;
            say("in $25 - target= " + $2.getIdentifier());
    ...
    $26: function () {
        ...
        this.$23();         
        var theSrc =  this.$C.getUrl();
        this.$3.src = theSrc;    
        say("will try get: " + this.$3.src);       
    },
    $27: function () {
        //say("in $27 detachEvent onload");
...
Run = function () { };
Run.ManifestByURL = function (url, cache) {
    say("Run.ManifestByURL called");    
    //
    ...
    // X-domain xml request try
    /*
    if (window.XDomainRequest)      { Run.$0 = new XDomainRequest(); say("request type: XDomain"); }
    else if (window.XMLHttpRequest) { Run.$0 = new XMLHttpRequest(); say("request type: XMLHttp"); }
    else { Run.$0 = new ActiveXObject("Microsoft.XMLHTTP"); say("request type: ActiveXObject"); }
    */
    Run.$0 = new XMLHttpRequest();  
    //
    Run.$0.onreadystatechange = Delegate.create(null, Run.$3);
    if (!cache) url += '?anticache=' + Math.random();
    say("request ajax url to run: " + url);
    Run.$0.open('GET', url, false);    
    say("Run.$0.open Returned");
    Run.$0.send();
    say("Run.$0.send() Returned");
}
Run.ManifestByString = function (manifest) {
    //say("got inside run.manifestByString");
    Run.$1 = XMLDocumentParser.parse(manifest);
    //say("XMLDocumentParser.parse(manifest) returned");
...
Run.$3 = function () {
    try
    {
        //say("in run.$3, readyState =" + Run.$0.readyState);
        if (Run.$0.readyState === 4) {
            say("in run.$3, readyState === 4, Run.$0.responseXML: " + Run.$0.responseXML + " obj:" + Run.$0 + " check document.manifestRequest & manifestResponse" );
            document.manifestRequest = Run.$0;            
            document.manifestResponse = Run.$0.responseXML;            
            Run.$0.onreadystatechange = Delegate.Null;            
            if (!isNullOrUndefined(Run.$0.responseXML)) {                
                Run.$1 = Run.$0.responseXML;                
                Run.$4();               
                //say("run.$4() returned to run.$3");
        ...
        say("remote Run.$3 - Error description: " + err.message);
        document.getElementById(errorLogDivID).innerHTML =
            "Remote Run.$3 pool-player.js error: " + err.message +
...
Run.$4 = function () {
    ...
    //say("new Player.ContentPlayer returned");
    $0.showPlayer();
    //say("showPlayer returned");
}
